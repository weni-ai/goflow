...
func (ts *ServerTestSuite) buildResumeRequest(assetsJSON string, session flows.Session, msg *flows.MsgIn) string {
...
func (ts *ServerTestSuite) TestFlowStartAndResume() {
	...
	ts.Equal(400, status)
	ts.assertErrorResponse(body, []string{"unable to load flow[uuid=76f0a02f-3b75-4b86-9064-e9195e1b3a02]: validation failed for node[uuid=a58be63b-907d-4a1a-856b-0bb5579d7507]: destination 714f1409-486e-4e8e-bb08-23e2943ef9f6 of exit[uuid=37d8813f-1402-4ad2-9cc2-e9054a96525b] isn't a known node"})
	...
	ts.Equal(400, status)
	ts.assertErrorResponse(body, []string{"unable to read run 0: unable to load flow[uuid=76f0a02f-3b75-4b86-9064-e9195e1b3a02]: validation failed for node[uuid=a58be63b-907d-4a1a-856b-0bb5579d7507]: destination 714f1409-486e-4e8e-bb08-23e2943ef9f6 of exit[uuid=37d8813f-1402-4ad2-9cc2-e9054a96525b] isn't a known node"})
	...
	sessionJSON := ts.buildResumeRequest(`[]`, waitingSession, msg)
