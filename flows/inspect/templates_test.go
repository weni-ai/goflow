...
func TestTemplatePaths(t *testing.T) {
	...
	assert.Equal(t, []string{
		...
		"$.nodes[*].actions[@.type=\"send_wpp_msg\"].header.text",
		"$.nodes[*].actions[@.type=\"send_wpp_msg\"].header.attachments[*]",
		"$.nodes[*].actions[@.type=\"send_wpp_msg\"].body",
		"$.nodes[*].actions[@.type=\"send_wpp_msg\"].footer",
		"$.nodes[*].actions[@.type=\"send_wpp_msg\"].reply_message[*]",
