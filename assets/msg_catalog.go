...
func NewMsgCatalogParam(productSearch string, channelUUID uuids.UUID, searchType string, searchUrl string, apiType string, postalCode string) MsgCatalogParam {
	p := MsgCatalogParam{
